...
<!--<link href="${param.relative_root_path}css/jquery-ui.css" rel="stylesheet" type="text/css"/>-->
...
<!--<script src="${param.relative_root_path}js/jquery-ui.js" type="text/javascript"></script>-->
